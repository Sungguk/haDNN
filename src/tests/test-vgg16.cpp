...
int main(int argc, char* argv[]) {
	...
	auto pool1 = new Pooling(relu12, {2, 2}, PoolingMode::MAX);
	// 64, 112, 112
	...
	auto pool2 = new Pooling(relu22, {2, 2}, PoolingMode::MAX);
	// 128, 56, 56
	...
	auto pool3 = new Pooling(relu33, {2, 2}, PoolingMode::MAX);
	// 256, 28, 28
	...
	auto pool4 = new Pooling(relu43, {2, 2}, PoolingMode::MAX);
	// 512, 14, 14
	...
	auto pool5 = new Pooling(relu53, {2, 2}, PoolingMode::MAX);
	// 512, 7, 7
